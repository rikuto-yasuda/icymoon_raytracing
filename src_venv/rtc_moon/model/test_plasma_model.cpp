...
double plasma::moon_simple::getDensity(const vector &point) const ///////////////?øΩV?øΩ?øΩ?øΩ?øΩ?øΩv?øΩ?øΩ?øΩY?øΩ}?øΩ?øΩ?øΩf?øΩ?øΩ?øΩiz?øΩ?øΩ?øΩ?øΩ?øΩ?øΩ?øΩ?øΩexp?øΩ≈åÔøΩ?øΩ?øΩ?øΩj
{
	const double
		r = std::sqrt((pow(point(0), 2.0)) + (pow(point(1), 2.0)) + (pow(point(2) + 1.7374e6, 2.0)));
	const double
		t = std::fabs(900e6 * exp(-1 * pow(((r - 1737.4e3) / 25e3), 3))); // ?øΩJ?øΩ?øΩ?øΩX?øΩg?øΩ√êÔøΩ?øΩ?øΩ?øΩ?øΩ?øΩs?øΩ?øΩ?øΩf?øΩ?øΩ ?øΩn?øΩ\?øΩ Ç≈ÇÃñÔøΩ?øΩx?øΩ?øΩ ?øΩn?øΩ\?øΩ ÇÔøΩ3.5*10^2(/cc) ?øΩX?øΩP?øΩ[?øΩ?øΩ?øΩn?øΩC?øΩg100km
	;
	return t;
}