...
for FREQ in 80 108 136 164 192 220 248 276 304 332 360 388 416 444 472 500 528 556 584 612
do
...
## ��ǥ������ ##
PLASMA="moon_simple"    #(null|test_null|simple|test_simple|europa_plume|europa_nonplume|ganymede_nonplume|sato|nsumei|devine_garrett)
...
## ���ϥե�����̾����ꤹ��?
OUTPUT="ray-P${PLASMA}_900cc_25km_v3-M${MAGNET}-${PLANET}-${MODE}-Z${SZ}-FR${FREQ}"
