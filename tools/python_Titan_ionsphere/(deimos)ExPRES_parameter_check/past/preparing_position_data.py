...
Source_latitude = 75
Source_beam_angle_range = [50, 60, 70, 80, 89]

Source_beam_angle = 75  # beam angle of the radio source
Source_latitude_range = [60, 70, 80, 89]  # latitude range of the radio source
...
hour = 9
minutes = 0
frequency = 0.63125002 # 0.090071, 0.1139, 0.17393 ,0.24168999, 0.27829, 0.32043001, 0.36875001, 0.43125001, 0.46875, 0.53125, 0.56875002, 0.63125002, 0.66874999, 0.73124999, 0.76875001, 0.83125001, 0.86874998 0.93124998  0.96875
Source_type = "B"
...
def Spacecraft_ephemeris_calc(spacecraft_ephemeris_data, moon_ephemeris_data, radio_source_data, hour, minutes, frequency, source_type):
    ...
    radio_source_frequency_index_lower = np.where(radio_source_data[:, 9] > frequency-0.00001)[0]
    radio_source_frequency_index_upper = np.where(radio_source_data[:, 9] < frequency+0.00001)[0]
...
def plot_source_latitude_dev(source_beam_angle, source_type, frequency):
    ...
    axs[3].set_xticks(np.arange(-10, 10, 2.5))
    axs[3].set_yticks(np.arange(-5, 5, 2.5))
    ...
    plt.savefig("/work1/rikutoyasuda/tools/result_titan/expres_detectable_radio_data_of_each_flyby/source_beam_angle_"+str(source_beam_angle)+"_radio_type_"+source_type+"_frequency_"+str(frequency)+"2MHz.png")
...
def plot_beaming_angle_dev(source_latitude, source_type, frequency):
    ...
    plt.savefig("/work1/rikutoyasuda/tools/result_titan/expres_detectable_radio_data_of_each_flyby/source_latitude_"+str(source_latitude)+"_radio_type_"+source_type+"_frequency_"+str(frequency)+"2MHz.png")
