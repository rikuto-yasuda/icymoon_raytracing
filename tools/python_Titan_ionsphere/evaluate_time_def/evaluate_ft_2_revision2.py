    ...
    if moon_name == "titan":
        ...
        if flyby_time == 15:
            ...
            if ingress_or_egerss == "ingress":
                ...
                using_frequency_range = [0.3, 0.8]  # T15 ingress                
                contor_dif = [30, 40, 50]
                uncertainty = 0  # typeB
                ...
                using_frequency_range = [0.3, 0.65]  # T15 egress
                contor_dif = [20, 30, 40]
                uncertainty = 0  # typeA
...
def plot_difference(maxdens, peakheight, sigma, RH_radio_type, LH_radio_type, using_frequency_array ,using_frequency_range):
    ...
    for i in output_freq_position:
        ...
        if polarization_icon == 1:
            total_time_difference += LH_time_difference_array[closest_index]
            total_frequency_number += 1
        
        elif polarization_icon == -1:
            total_time_difference += RH_time_difference_array[closest_index]
            total_frequency_number += 1
