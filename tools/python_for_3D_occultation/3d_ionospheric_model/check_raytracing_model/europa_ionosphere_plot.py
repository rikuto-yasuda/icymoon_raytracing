...
df = np.genfromtxt('/Users/yasudarikuto/research/icymoon_raytracing/src_venv/rtc_clare_model/tools/map_model/pxz-normal')
l_2d = len(df)
x_min = df[0,0]
x_max = df[-1,0]
z_min = df[0,2]
...
plt.xlim(-4*1460.8, 4*1460.8)
plt.ylim(-4*1460.8, 4*1460.8)
...
# %%
df = np.genfromtxt('/Users/yasudarikuto/research/icymoon_raytracing/src_venv/rtc_clare_model/tools/map_model/pxy_normal')
l_2d = len(df)
x_min = df[0,0]
x_max = df[-1,0]
y_min = df[0,1]
