...
earth_csv_name = "WGC_StateVector_20230103152757.csv"
jupiter_csv_name = "WGC_StateVector_20230103153041.csv"
sun_csv_name = "WGC_StateVector_20230103153149.csv"
spacecraft_csv_name = "WGC_StateVector_20230103153335.csv"


# ヘッダーの位置と末端のデータの位置をheaderとskipfooterで設定
jupiter_csv = pd.read_csv(
    "../../result_for_yasudaetal2022/previous_study_ephemeris_revised/jupiter_ephemeris/"
    + jupiter_csv_name,
    header=17,
    skipfooter=2,
)
sun_csv = pd.read_csv(
    "../../result_for_yasudaetal2022/previous_study_ephemeris_revised/sun_ephemeris/"
    + sun_csv_name,
    header=17,
    skipfooter=2,
)
spacecraft_csv = pd.read_csv(
    "../../result_for_yasudaetal2022/previous_study_ephemeris_revised/spacecraft_ephemeris/"
    + spacecraft_csv_name,
    header=17,
    skipfooter=2,
)
...
earth_csv = pd.read_csv(
    "../../result_for_yasudaetal2022/previous_study_ephemeris_revised/earth_ephemeris/"
    + earth_csv_name,
    header=17,
    skipfooter=2,
)
...
def save_all_result(
    ...
    print(df2)
    df2.to_csv(
        "../../result_for_yasudaetal2022/previous_study_ephemeris_revised"
        + "/results/"
        + object_name
        + "_"
        + str(time_of_flybies)
