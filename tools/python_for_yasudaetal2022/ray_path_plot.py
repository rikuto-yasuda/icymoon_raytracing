...
def ray_plot(height, width):
    ...
    x = data[:, [1]]
    z = data[:, [3]]
    plt.plot(x, z, color="red", linewidth=width)
...
def main():
    ...
    plt.savefig(
        "../result_for_yasudaetal2022/ray_path_plot_for_paper/figure3_inthesis.jpg",
        format="jpg",
        dpi=600,
    )
    plt.show()
    ...
    plt.savefig(
        "../result_for_yasudaetal2022/ray_path_plot_for_paper/figure3_inthesis_2.jpg",
        format="jpg",
        dpi=600,
    )
    plt.show()
