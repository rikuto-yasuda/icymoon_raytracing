...
# C9 flyby
plot_time_step_sec = [0, 1800, 3600, 5400, 7200, 9000, 10800]
plot_time_step_label = ["12:00", "12:30",
...
# %%
#
for max_dense in ['10.5e2', '11e2', '11.5e2', '12e2', '12.5e2', '13e2', '13.5e2', '14e2', '14.5e2', '15e2', '15.5e2', '16e2', '16.5e2', '17e2', '17.5e2', '18e2', '18.5e2', '19e2', '19.5e2', '20e2', '20.5e2']:
    highest_plasma = max_dense
    ...
    def Pick_up_cdf():
        ...
        radio_data_name = str(
            complete_selecred_flyby_list['radio_data_txt'][0])
    ...
    def Make_FT_full(DataA, DataB, DataC, DataD, raytrace_time_information, radio_data_name):
        ...
        time_list = np.arange(0, time_step, 60)
        ...
        def plot_and_save(start_time, end_time, name):
            ...
            ax.contour(time_list, FREQ, DataB, levels=[
                       0.5], colors='lightgray')
