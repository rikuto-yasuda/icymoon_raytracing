...
for i in range(100,1301,100):
    n = str(i)
    N = i
    filename = np.genfromtxt("/Users/yasudarikuto/research/raytracing/tools/results/for_JpGU_2021/europa_stop_5MHz/ray-Peuropa_nonplume-Mtest_simple-benchmark-LO-Z"+n+"-FR5e6")
