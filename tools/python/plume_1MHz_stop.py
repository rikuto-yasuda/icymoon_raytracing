...
for i in range(100,1301,100):
    n = str(i)
    N = i
    filename = np.genfromtxt("/Users/yasudarikuto/research/raytracing/tools/results/for_JpGU_2021/europa_plume_stop_1MHz/ray-Peuropa_plume-Mtest_simple-benchmark-LO-Z"+n+"-FR1e6")
