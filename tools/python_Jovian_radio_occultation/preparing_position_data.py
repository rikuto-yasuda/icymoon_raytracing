...
def Pick_up_cdf():
    ...
    cdf_file = cdflib.CDF("../result_for_yasudaetal2022/expres_cdf_data/" + cdf_name)
...
def Interpolate_radio_source_and_save(
    ...
    np.savetxt(
        "../result_for_yasudaetal2022/expres_detectable_radio_data_of_each_flyby/Interpolated_all_"
        + spacecraft_name
        + "_"
        + object_name
        + "_"
