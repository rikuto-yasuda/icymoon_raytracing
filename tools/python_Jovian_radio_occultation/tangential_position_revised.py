...
begining_ingress_hour = 11
begining_ingress_minute = 21

end_ingress_hour = 11
end_ingress_minute = 26

lowest_frequency_ingress = 0.8
highest_frequecy_ingress = 5.5

radio_type_ingress = "B"  # 複数選択可能にしたい

begining_egress_hour = 11
begining_egress_minute = 45

end_egress_hour = 12
end_egress_minute = 5

lowest_frequency_egress = 0.5
