...
df = np.genfromtxt('/Users/yasudarikuto/research/raytracing/raytrace.tohoku/src/rtc/tools/map_model/gany_sgepss_plasma_map')
l_2d = len(df)
...
for i in range(100,1301,100):
    n = str(i)
    N = i
    filename = np.genfromtxt("/Users/yasudarikuto/research/raytracing/tools/results/for_JpGU_2021/europa_stop_1MHz/ray-Peuropa_nonplume-Mtest_simple-benchmark-LO-Z"+n+"-FR1e6")
