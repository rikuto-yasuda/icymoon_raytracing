#for HIG in -200 -100 0 100 500 600 #1000 1100 1500 1600 2000 2100 2500 2600 3000 3100 3500 3600 4000 4100 4500 4600 5000 5100 5500 5600 6000 6100 6500 6600 7000 7100 7500 7600 8000 8100
...
## ���ϥե�����̾����ꤹ�롣
OUTPUT="ray-P${PLASMA}_0e2_0.5e2-M${MAGNET}-${PLANET}-${MODE}-Z${SZ}-FR${FREQ}"
