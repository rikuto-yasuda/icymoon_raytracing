...
#for HIG in `seq 1400 2 1600`
#for HIG in `seq 500 2 600`
#for HIG in `seq -100 2 -90`
...
#for FREQ in 4.395893216133117676e5 4.849380254745483398e5
#for FREQ in 5.349649786949157715e5 5.901528000831604004e5 6.510338783264160156e5 7.181954979896545410e5 7.922856807708740234e5 8.740190267562866211e5
#for FREQ in 9.641842246055603027e5 1.063650846481323242e6 1.173378825187683105e6 1.294426321983337402e6 1.427961349487304688e6 1.575271964073181152e6 
#for FREQ in 1.737779378890991211e6 1.917051434516906738e6 2.114817380905151367e6
#for FREQ in 2.332985162734985352e6 2.573659420013427734e6 2.839162111282348633e6 3.132054328918457031e6 3.455161809921264648e6 3.811601638793945312e6 4.204812526702880859e6 4.638587474822998047e6 5.117111206054687500e6 5.644999980926513672e6 
do
...
## 出力ファイル名を指定する。
OUTPUT="ray-P${PLASMA}_2e2_1.5e2-M${MAGNET}-${PLANET}-${MODE}-Z${SZ}-FR${FREQ}"
