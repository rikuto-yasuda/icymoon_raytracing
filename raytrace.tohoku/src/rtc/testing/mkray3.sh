...
#for FREQ in 3.984813988208770752e5 4.395893216133117676e5 4.849380254745483398e5 5.349649786949157715e5
...
#for FREQ in 1.063650846481323242e6 1.173378825187683105e6 1.294426321983337402e6 1.427961349487304688e6 1.575271964073181152e6
...
## 出力ファイル名を指定する。
OUTPUT="ray-P${PLASMA}_4e2_4e2-M${MAGNET}-${PLANET}-${MODE}-Z${SZ}-FR${FREQ}"
