...
#for FREQ in 1.173378825187683105e6 1.294426321983337402e6 1.427961349487304688e6 1.575271964073181152e6
...
## ���ϥե�����̾����ꤹ�롣
OUTPUT="ray-P${PLASMA}_6.5e2_4e2-M${MAGNET}-${PLANET}-${MODE}-Z${SZ}-FR${FREQ}"
