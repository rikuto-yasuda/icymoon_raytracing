...
#for FREQ in 4.395893216133117676e5 4.849380254745483398e5 5.349649786949157715e5
#for FREQ in 5.901528000831604004e5 6.510338783264160156e5
...
## 出力ファイル名を指定する。
OUTPUT="ray-P${PLASMA}_0.5e2_7.5e2-M${MAGNET}-${PLANET}-${MODE}-Z${SZ}-FR${FREQ}"
