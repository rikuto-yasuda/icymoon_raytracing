...
#for HIG in `seq -700 2 2100`
#for HIG in `seq -300 2 1600`
...
#for FREQ in 3.612176179885864258e5 3.984813988208770752e5 4.395893216133117676e5 4.849380254745483398e5 5.349649786949157715e5
#for FREQ in 5.901528000831604004e5 6.510338783264160156e5 7.181954979896545410e5 7.922856807708740234e5 8.740190267562866211e5 9.641842246055603027e5
#for FREQ in 1.063650846481323242e6 1.173378825187683105e6 1.294426321983337402e6 1.427961349487304688e6 1.575271964073181152e6 1.737779378890991211e6 1.917051434516906738e6 2.114817380905151367e6 2.332985162734985352e6 2.573659420013427734e6 2.839162111282348633e6 3.132054328918457031e6
...
## ���ϥե�����̾����ꤹ�롣
OUTPUT="ray-P${PLASMA}_8e2_4e2-M${MAGNET}-${PLANET}-${MODE}-Z${SZ}-FR${FREQ}"
